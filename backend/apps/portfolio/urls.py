...
urlpatterns = [
    ...
    path("meta/technologies/<int:pk>/",        views.TechnologyDetailView.as_view(),          name="technology-detail"),
    ...
    # GitHub import
    path("github/validate-username/",          views.GitHubValidateUsernameView.as_view(),   name="github-validate-username"),
    path("github/repos/",                      views.GitHubReposView.as_view(),              name="github-repos"),
    path("github/import/",                     views.GitHubImportView.as_view(),             name="github-import"),
]